package com.example.tallerdb.model;
...
public class ManageDB extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE = "CREATE TABLE " + TABLE_USERS + "(usu_document INTEGER PRIMARY KEY, " + "usu_user varchar(35) NOT NULL, usu_names varchar(100) NOT NULL, usu_last_names varchar(100) NOT NULL, usu_email varchar(100)," + "usu_pass varchar(20) NOT NULL);";
